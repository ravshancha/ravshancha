...
def main():
    ...
    # The shared endpoint (site/api/lead.php) accepts only these answer codes and writes their labels
    # (first language) into the spreadsheet, so the quiz map is generated next to it.
    quiz_rows = []
    ...
    quiz_map = os.path.join(REPO, "site", "api", "lead-quiz.php")
